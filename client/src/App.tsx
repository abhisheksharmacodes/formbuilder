...
function FormBuilder({ onSwitchView }: { onSwitchView: () => void }) {
  // State management
...
function FormViewer({ onSwitchView }: { onSwitchView: () => void }) {
...
function App() {
  ...
  return (
    <>
      {viewMode === 'builder' ? (
        <FormBuilder onSwitchView={switchToViewer} />
      ) : (
        <FormViewer onSwitchView={switchToBuilder} />
      )}
    </>
  )
}
